  ...
  return (
    <div className='ani'>
      ...
      <div className="signup-container">
        ...
        <div className="form-group">
          <label htmlFor="email" style={{marginTop:5}}>Email</label>
          <input
            type="email"
            id="email"
            name="email"
        ...
        <div className="form-group">
          <label htmlFor="password" style={{marginTop:5}}>Password</label>
          <input
            type="password"
            id="password"
            name="password"
        ...
        <div className="form-group">
          <label htmlFor="confirmPassword" style={{marginTop:5}}>Confirm Password</label>
          <input
            type="password"
            id="confirmPassword"
        ...
        <div className="form-group">
          <label htmlFor="mobileNumber" style={{marginTop:5}}>Mobile Number</label>
          <input style={{width:400,height:50}}
            type="text"
            id="mobileNumber"
            name="mobileNumber"
        ...
        <button  style={{width:200}}onClick={handleSubmit}>Register</button>
